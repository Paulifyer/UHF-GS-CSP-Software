...
/* BACKEND_FILE used to be BACKEND_NEWLIB */
#define BACKEND_NEWLIB			BACKEND_FILE
...
typedef enum __attribute__ ((__packed__)) {
	...
	FTP_ZIP_REQUEST      = 21,
	FTP_ZIP_REPLY        = 22,
	FTP_COPY_REQUEST     = 23,	/**< Copy request */
	FTP_COPY_REPLY       = 24,	/**< Copy reply */
...
typedef enum __attribute__ ((__packed__)) {
	...
	FTP_RET_BUSY			= 10,	/**< Device or resource busy */
} ftp_return_t;
